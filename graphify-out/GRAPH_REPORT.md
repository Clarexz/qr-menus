...
## Summary
- 196 nodes · 244 edges · 17 communities (14 shown, 3 thin omitted)
- Extraction: 96% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.76)
...
- **Production verification flow across routes** — documentation_progress_fase_4_deploy_vercel_production_url, documentation_progress_fase_4_deploy_vercel_menu_route, documentation_progress_fase_4_deploy_vercel_dashboard_route, documentation_progress_fase_4_deploy_vercel_dashboard_qr_route [EXTRACTED 1.00]
...
### Community 2 - "Dashboard CRUD (Fase 2)"
Cohesion: 0.19
Nodes (18): createItemAction(), deleteItemAction(), refresh(), updateItemAction(), dynamic, dynamic, MenuPage(), createItem() (+10 more)

### Community 3 - "Fase 4 Deploy Vercel"
Cohesion: 0.13
Nodes (19): Fase 4 — Deploy a Vercel, Casa Milpa (negocio de ejemplo), curl HTML inspection (dashboard input values verification), /dashboard/qr route, /dashboard route, Vercel Deployment Protection / Vercel Authentication, Fase 2 (verificación local con Playwright), Fase 3 (+11 more)

### Community 4 - "Runtime Deps (next/react/qrcode)"
Cohesion: 0.11
Nodes (17): next, dependencies, next, qrcode.react, react, react-dom, name, private (+9 more)

### Community 5 - "Dev Tooling Deps (lint/types)"
Cohesion: 0.13
Nodes (15): eslint, eslint-config-next, devDependencies, eslint, eslint-config-next, postcss, @types/node, @types/react (+7 more)

### Community 6 - "QR Card + Site URL (implementacion)"
Cohesion: 0.24
...
### Community 7 - "Fases 0-6 del Roadmap"
Cohesion: 0.21
...
### Community 8 - "Plan de Implementacion (docs raiz)"
Cohesion: 0.22
...
## Knowledge Gaps
- **73 isolated node(s):** `MenuCategory`, `MenuData`, `MenuItem`, `dynamic`, `dynamic` (+68 more)
...
- **Why does `devDependencies` connect `Dev Tooling Deps (lint/types)` to `Plan de Implementacion (docs raiz)`, `Runtime Deps (next/react/qrcode)`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
